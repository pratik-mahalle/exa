...
const download = `${repo}/releases/download/v0.3.1/Cloudwake-0.3.1-macos-arm64.zip`;
    ...
    <div className="cloudwake-page" id="top">
      ...
      <main id="cloudwake-main">
        <section className="cw-hero cw-shell" aria-labelledby="cw-title">
          ...
          <BrewCommand />
          <p className="cw-install-note"><a href={`${repo}/blob/main/docs/downloads.md`}>Early release, not notarized</a> · Starts in demo mode</p>
        </section>
