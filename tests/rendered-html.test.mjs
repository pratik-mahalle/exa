...
test("Cloudwake has its own rendered content, metadata, and real setup destination", async () => {
  ...
  assert.match(html, /href="https:\/\/github.com\/pratik-mahalle\/infralive\/releases\/download\/v1.2.0\/Cloudwake-1.2.0-macos-arm64.zip"/);
  ...
  assert.match(html, /releases\/tag\/v1.2.0/);
