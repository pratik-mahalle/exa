...
test("Cloudwake has its own rendered content, metadata, and real setup destination", async () => {
  ...
  assert.match(html, /href="https:\/\/github.com\/pratik-mahalle\/cloudwake-releases\/releases\/download\/v1.2.1\/Cloudwake-1.2.1-macos-arm64.zip"/);
  ...
  assert.match(html, /releases\/tag\/v1.2.1/);
